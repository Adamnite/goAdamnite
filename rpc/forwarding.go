...
type ForwardingContent struct {
	...
	DestinationNode *utils.Address //null if its for everyone
	...
	InitialSender   utils.Address  //who started this
}

func (fc ForwardingContent) Hash() utils.Hash {
	...
	return utils.BytesToHash(crypto.Sha512(byteForm))
}
