...
func TestClientBatchRequest(t *testing.T) {
	...
	wantResult := []AdamniteBatchElement{
		{
			Method: "test_echo",
			Args:   []interface{}{"hello", 10, &echoArgs{"world"}},
...
func httpTestClient(srv *Server, transport string, fl *flakeyListener) (*AdamniteClient, *httptest.Server) {
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*AdamniteClient, net.Listener) {
	// Listen on a random endpoint.
	endpoint := fmt.Sprintf("go-adamnite-test-ipc-%d-%d", os.Getpid(), rand.Int63())
