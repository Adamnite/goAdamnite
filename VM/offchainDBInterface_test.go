...
var (
	...
	testContract          = newContract(utils.BytesToAddress([]byte{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08}), big.NewInt(0), nil, 10000)
	...
	state, _      = statedb.New(utils.Hash{}, statedb.NewDatabase(db))
