...
func ConvertTransactions(transactions []*types.Transaction) []*utils.Transaction {
	var ts []*utils.Transaction
...
func convertTransaction(t *types.Transaction) *utils.Transaction {
	ans := utils.Transaction{
