//Copyright the GoAdamnite Authors
// Inspirations for this code, and their corresponding licenses, can be found in the Acknowledgements Folder.
...
import (
	...
	//Import relevant Adamnite Packages here
)

// This is a node in a binary trie
...
//Adamnite does not have a storage storage trie; storage slots, or some concept of off-chain storage, should be implemented in the database.
...
// Removed storage, maybe be include some reference to the off-chain db? The hash itself is stored as a keyvalue
