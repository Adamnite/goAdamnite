// Copyright 2020 The goAdamnite Authors
// This file is part of the goAdamnite library.
//
// The goAdamnite library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The goAdamnite library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the goAdamnite library. If not, see <http://www.gnu.org/licenses/>.
...
// 	diskdb adamnitedb.KeyValueStore
...
// 	if len(key) == 32 {
// 		if err := msgpack.Decoder(value, &br.account); err != nil {
// 			panic(err)
// 		}
...
// 	panic("can't hash accounts with only NewMemoryDatabase")
// }
...
// func NewBinaryTrieWithRawDB(db adamnitedb.KeyValueStore) *BinaryTrie {
// 	bt := &BinaryTrie{
// 		root: empty(struct{}{}),
// 		db: btDatabase{
// 			diskdb:  db,
