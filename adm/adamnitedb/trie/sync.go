...
// 	"github.com/ethereum/go-adamnite/adamnitedb"
// 	"github.com/ethereum/go-ethereum/common/prque"
// 	// "github.com/ethereum/go-adamnite/common"
// 	// "github.com/ethereum/go-ethereum/common/prque"
// )
...
// type Sync struct {
// 	database adamnitedb.KeyValueReader // Persistent database to check for existing entries
...
// func NewSync(root common.Hash, database adamnitedb.KeyValueReader, callback LeafCallback, bloom *SyncBloom) *Sync {
// 	ts := &Sync{
// 		database: database,
...
// 	if bytes.Compare(root.Bytes(), emptyRoot) == 0 {
// 		return
// 	}
...
// 	if bytes.Compare(hash.Bytes(), emptyRoot) == 0 {
// 		return
// 	}
...
// func (s *Sync) Commit(dbw adamnitedb.Batch) error {
