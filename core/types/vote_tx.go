...
type VoteTransaction struct {
	...
	Candidate utils.Address // the candidate address of witness or block producer
...
func NewVoteTransaction(nonce uint64, candidate utils.Address, atePrice *big.Int, ateMax uint64) *Transaction {
...
func (tx *VoteTransaction) to() *utils.Address    { return nil }
